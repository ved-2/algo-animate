...
const items = [
  ...
  { title: "Manage Tasks", url: "/dashboard/tasks", icon: Inbox },
  { title: "Create Tasks", url: "/dashboard/createTask", icon: Calendar },
  { title: "Insights", url: "/dashboard/insights", icon: Search },
  { title: "Back to Visualize", url: "/visualize", icon: LogOutIcon },
];
